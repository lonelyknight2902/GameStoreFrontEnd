const FeatureCard = ({featureGame, isActive, onClick}) => {
  return (
    <div onClick={(e) => onClick(e)} className={`flex text-white items-center cursor-pointer gap-4 py-2 px-4 bg-transparent duration-500 ${isActive ? "bg-zinc-700" : ""} rounded-lg`}>
